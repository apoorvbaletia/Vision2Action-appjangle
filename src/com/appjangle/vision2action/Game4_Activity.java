...
import com.appjangle.vision2action.game4.LoadBusinessProcessQuestion;
import com.appjangle.vision2action.game4.BusinessProcessQuestion;


public class Game4_Activity extends Activity implements View.OnTouchListener,OnClickListener {
...
String result4 = "";
String video = "";
String t1,t2,t3,value1,value2,value3;
Node cases;
TextView textView1 ;
...
public void onCreate(Bundle savedInstanceState) {
    ...
    _view.setBackgroundResource(R.drawable.businessstepbutton);
    
    _view2 = new TextView(this);
    _view2.setBackgroundResource(R.drawable.businessstepbutton);
    
    _view3 = new TextView(this);
    _view3.setBackgroundResource(R.drawable.businessstepbutton);
    ...
    BusinessProcessQuestion case1game1 = LoadBusinessProcessQuestion
			.getQuestionFromNode(Vision2Action.session, Vision2Action.session.node(getIntent().getStringExtra("uri") + "/c" + temp));

	
	result = case1game1.getProcessSteps();
	result2 = case1game1.getProcessName();
	result3 = case1game1.getImportantProcess();
...
public void popup()
{ 
		 LayoutInflater inflater = (LayoutInflater) Game4_Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

		 View layout = inflater.inflate(R.layout.popup2,(ViewGroup) findViewById(R.id.xx));
		 
		 pw = new PopupWindow(layout, 560, 400, true);
		 pw.showAtLocation(layout, Gravity.CENTER, 0, 0);
		         
		 TextView popuptext = (TextView) layout.findViewById(R.id.textView1);
		 popuptext.setText( result2 + ":\n" + result3);
		 
		 TextView headertext = (TextView) layout.findViewById(R.id.textView2);
		 headertext.setText("Congratulations!!!");
		 
		 
		 final Intent jjj=new Intent(this,Game5_Activity.class);
		 jjj.putExtra("uri", getIntent().getStringExtra("uri"));
		 jjj.putExtra("value1", value1);
		 jjj.putExtra("value2", value2);
		 jjj.putExtra("value3", value3);
		 ...
		 Button btnGonext = (Button) layout.findViewById(R.id.widget42);
		 btnGonext.setOnClickListener(new View.OnClickListener(){public void onClick(View v){pw.dismiss();startActivity(jjj);}});
